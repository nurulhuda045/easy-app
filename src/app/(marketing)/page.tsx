      ...
      <section className="bg-primary text-primary-foreground">
        <div className="container py-16 flex flex-col gap-16 px-8 md:px-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-16">
            <Link href="https://www.neon.tech">
              <NeonIcon />
            </Link>
            <Link href="https://www.clerk.com">
              <ClerkIcon />
            </Link>
            <Link href="https://www.neon.tech">
              <NeonIcon />
            ...
            <Link className="md:max-xl:hidden" href="https://www.clerk.com">
              <ClerkIcon />
            </Link>
          </div>
        </div>
    ...
    <Card>
      ...
      <CardFooter className="flex flex-col gap-4 items-start">
        <Feature className="font-bold">
          {maxNumberOfProducts}
          {maxNumberOfProducts > 1 ? " products" : " product"}
        </Feature>
        <Feature>PPP discounts</Feature>
        {canAccessAnalytics && <Feature>Advanced analytics</Feature>}
        {canRemoveBranding && <Feature>Remoce Easy PPP branding</Feature>}
        {canCustomizeBanner && <Feature>Banner custimization</Feature>}
      </CardFooter>
    </Card>
  );
}
