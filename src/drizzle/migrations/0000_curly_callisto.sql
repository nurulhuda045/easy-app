...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "product_customization" ADD CONSTRAINT "product_customization_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
